...
public class ComplexSum implements ComplexFunction, Glyph {

	ComplexFunction mLHS;
	ComplexFunction mRHS;
	
	public ComplexSum(ComplexFunction aLS, ComplexFunction aRS){
		mLHS = aLS;
		mRHS = aRS;
	}
	...
	public Complex getResult(float aOmega) {
		return mLHS.getResult(aOmega).plus(mRHS.getResult(aOmega));
	}
	...
	public int getHeight() {
		...
		Log.d("czyta","SUM: " + Math.max(lh, rh));
