...
public class ComplexMult implements ComplexFunction, Glyph {

	ComplexFunction mLHS;
	ComplexFunction mRHS;
	
	public ComplexMult(ComplexFunction aLS, ComplexFunction aRS){
		mLHS = aLS;
		mRHS = aRS;
	}
	...
	public Complex getResult(float aOmega) {
		return mLHS.getResult(aOmega).times(mRHS.getResult(aOmega));
	}
	
	public String toString(){
		return "mult("+mLHS.toString()+","+mRHS.toString()+")";
	}
	...
	public int getHeight() {
		...
		Log.d("czyta","MULT: " + Math.max(lh, rh));
